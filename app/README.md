...
Chaque vidéo peut désormais conserver plusieurs tests publicitaires manuels. La marque est le champ principal. Les autres données disponibles sont l’entreprise annonceuse, la présence ou non d’une publicité, la date, l’heure, le pays ou la localisation, le format, une preuve et des notes. Toutes ces variables peuvent être activées ou retirées dans les options de l’export Excel.
