...
for (const input of [els.collectorMode, els.detectTimeout, els.betweenVideos, els.location, els.mutePlayback, els.saveScreenshots, els.closeWindow]) {
...
els.exportButton.addEventListener("click", async () => {
  ...
  const payload = {
    schema: "yt-preroll-collector-results-v3",
