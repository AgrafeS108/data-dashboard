...
const STORAGE_KEY = "ytPreRollCollectorStateV3";
const LEGACY_STORAGE_KEYS = ["ytPreRollCollectorStateV2", "ytPreRollCollectorStateV1"];
const WATCHDOG_ALARM = "yt-preroll-collector-watchdog-v3";
const VERSION = "1.2.0";
...
async function restoreOriginFocus(state) {
  ...
  // La page YouTube doit réellement prendre le focus un court instant pour que Chrome
  // autorise la lecture et que les composants publicitaires s'initialisent correctement.
