...
const STORAGE_KEYS = {
  ...
  exportColumns: "yt-channel-viewer-export-columns-v7",
  legacyExportColumns: ["yt-channel-viewer-export-columns-v6", "yt-channel-viewer-export-columns-v5", "yt-channel-viewer-export-columns-v4"],
...
const ESSENTIAL_EXPORT_KEYS = [
  ...
  "adAdvertiserPrimary", "adAdvertisersWithCounts", "adTestCount", "adShownCount"
];
