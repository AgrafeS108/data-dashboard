...
function hydrateVideoDerivedFields(v) {
    ...
    try {
        ...
        // Recalcule systématiquement la classification à partir du titre réel.
        // Les anciennes versions pouvaient garder un __ftv_cls obsolète, ce qui
        // injectait par exemple un short rugby dans Tennis/Roland-Garros.
