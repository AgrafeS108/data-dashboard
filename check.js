        ...
        React.createElement("div", { className: "ftv-main-shell", style: { flex: 1, display: 'flex', flexDirection: 'column', overflow: 'hidden' } },
            React.createElement("div", { className: "ftv-main-tabs", style: { padding: '0 18px', background: 'var(--bg2)', borderBottom: '1px solid var(--border)',
                ...
                userMenuOpen && React.createElement(React.Fragment, null,
                    React.createElement("div", { onClick: () => setUserMenuOpen(false), style: { position: 'fixed', inset: 0, zIndex: 20000, background: 'rgba(15,23,42,.42)', backdropFilter: 'blur(10px)', WebkitBackdropFilter: 'blur(10px)' } }),
                    React.createElement("aside", { onClick: e => e.stopPropagation(), style: { position: 'fixed', top: 0, right: 0, bottom: 0, width: 'min(390px,92vw)', zIndex: 20001,
                            background: 'var(--bg2)', borderLeft: '1px solid var(--border)', boxShadow: '-32px 0 90px rgba(15,23,42,.26)',
