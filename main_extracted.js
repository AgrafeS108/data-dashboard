...
@media (max-width:760px), (pointer:coarse) and (max-width:920px){
  ...
  .ftv-m-drawer-backdrop{z-index:300 !important;}
  .ftv-m-drawer{z-index:310 !important;}
}
</style>
...
function DetailPanel({ sport, data, totalViews, typeFilter, exportMode, selectedComps, onCheckComp, selectedVideos, onCheckVideo, taxonomyMode = 'sport', onReclassify }) {
    ...
    return (React.createElement("div", { className: "ftv-detail-panel", style: { display: 'flex', flexDirection: 'column', height: '100%', animation: 'slideIn .12s ease' } },
        React.createElement("div", { className: "ftv-detail-header", style: { padding: '14px 18px', borderBottom: '1px solid var(--border)', display: 'flex', alignItems: 'center',
        ...
        React.createElement("div", { className: "ftv-detail-type-pills", style: { display: 'flex', gap: 7, padding: '8px 18px', borderBottom: '1px solid var(--border)', flexShrink: 0,
        ...
        React.createElement("div", { className: "ftv-comp-list", style: { overflowY: 'auto', flex: 1 } },
    ...
    return React.createElement(React.Fragment,null,
        ...
        React.createElement('aside',{className:'ftv-m-drawer '+(open?'is-open':''),role:'dialog','aria-modal':'true'},
            ...
            React.createElement('div',{className:'ftv-m-drawer-section'},
                ...
                React.createElement('select',{className:'ftv-m-drawer-select',value:channelKey,onChange:e=>onChannelChange(e.target.value)},Object.values(CHANNEL_CONFIGS).map(ch=>React.createElement('option',{key:ch.key,value:ch.key},ch.label)))
            ),
            React.createElement('button',{className:'ftv-m-drawer-row',onClick:()=>{window.open('/admin.html','_blank');}},React.createElement('span',null,'⚙️'),React.createElement('span',null,'Console admin')),
...
function MobilePeriodControls({dateRange,setDateRange,periodLabel}){
    ...
    return React.createElement(React.Fragment,null,
        React.createElement('div',{className:'ftv-m-period-row'},
            ...
            React.createElement('button',{className:'ftv-m-export-mini',onClick:()=>alert('Export disponible sur desktop pour cette version mobile.'),'aria-label':'Exporter'},'↓')
        ),
...
function MobileDashboardApp(props){
    ...
    const content = mainTab==='graphiques'
        ...
        : mainTab==='copilot'
        ? React.createElement(MobileGenericWrappedScreen,{title:'Copilot IA',subtitle:'Opportunités, risques et potentiel média'},React.createElement(PredictiveCopilotView,{allVideos:filteredVideos,sportsData,totalViews,channelKey,dateRange,analyticsBundle}))
        : mainTab==='analytics'
        ? React.createElement(MobileGenericWrappedScreen,{title:'Analytics',subtitle:'Données YouTube Analytics et signaux avancés'},React.createElement(AnalyticsView,{allVideos:filteredVideos,analyticsBundle,analyticsStatus,onConnect:connectYouTubeAnalytics,onLoad:loadYouTubeAnalyticsData,analyticsClientId,setAnalyticsClientId,analyticsAccessToken}))
